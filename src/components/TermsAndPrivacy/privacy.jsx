    ...
    return (
        <div>
            ...
            <div style={privacyPageCSS}>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the
                            ...
                            to MIZ, Kuala Lumpur, Malaysia.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Apu Findroom Mate, accessible from <a
                            href="https://apufindroommate.live/" rel="external nofollow noopener"
                            target="_blank">https://apufindroommate.live/</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <p>By email: yuenci1575270674@gmail.com</p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a
                            href="https://github.com/yuenci/APU-Roommate-finder/issues" rel="external nofollow noopener"
                            target="_blank">https://github.com/yuenci/APU-Roommate-finder/issues</a></p>
                    </li>
                </ul>
            </div>
            <Footer />
