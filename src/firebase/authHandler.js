...
export class FBAuth {
    ...
    sendEmailVerification() {
        return new Promise((resolve, reject) => {
            this.ifCurrentUserLoggedIn(reject, "Must be logged in to send email verification")
    ...
    updatePassword(newPassword) {
        return new Promise((resolve, reject) => {
            this.ifCurrentUserLoggedIn(reject, "Must be logged in to update password")
    ...
    getUserInfo() {
        return new Promise((resolve, reject) => {
            this.ifCurrentUserLoggedIn(reject, "Must be logged in to get user info")
            const user = this.auth.currentUser;
            const data = {
                uid: user.uid,
    ...
    updateUserInfo(newData) {
        return new Promise((resolve, reject) => {
            this.ifCurrentUserLoggedIn(reject, "Must be logged in to update user info")
            const user = this.auth.currentUser;
    ...
    updateUserEmail(newEmail) {
        return new Promise((resolve, reject) => {
            this.ifCurrentUserLoggedIn(reject, "Must be logged in to update user email")
            const user = this.auth.currentUser;
    ...
    deleteAccount() {
        return new Promise((resolve, reject) => {
            this.ifCurrentUserLoggedIn(reject, "Must be logged in to delete user");
            const user = this.auth.currentUser;
            deleteUser(user)
                .then(() => {
    ...
    reauthenticate(password) {
        return new Promise((resolve, reject) => {
            this.ifCurrentUserLoggedIn(reject, "Must be logged in to re-authenticate");
            const user = this.auth.currentUser;
